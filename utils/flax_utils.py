...
def restore_agent(agent, restore_path, restore_epoch):
    ...
    if 'modules_target_value' not in load_dict['agent']['network']['params'] and 'modules_value' in load_dict['agent']['network']['params']:
        load_dict['agent']['network']['params']['modules_target_value'] = copy.deepcopy(load_dict['agent']['network']['params']['modules_value'])
        mu_dict = load_dict['agent']['network']['opt_state']['0']['mu']
        mu_dict['modules_target_value'] = copy.deepcopy(mu_dict['modules_value'])
        nu_dict = load_dict['agent']['network']['opt_state']['0']['nu']
        nu_dict['modules_target_value'] = copy.deepcopy(nu_dict['modules_value'])
